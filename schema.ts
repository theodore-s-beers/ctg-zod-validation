...
// Regular expressions
const isoCode = /^[a-z]{3}$/;
const keyword = /^[a-z][a-z_]*[a-z]$/;
const latLng = /^-?\d{1,3}(\.\d{1,6})?$/;
const versionNumber = /^\d+\.\d+\.\d+$/;
          ...
          .array(
            z.object({
              ...
              coordinates: z.object({
                lat: z.string().regex(latLng).describe("Latitude of the place"),
                lng: z
                  .string()
                  .regex(latLng)
        ...
        contacts: z
          .array(
            z.object({
              ...
              websites: z
                .array(z.string().url())
                .describe("List of institutional and/or personal website URLs"),
            })
          )
